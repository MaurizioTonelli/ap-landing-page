...
const rows = [
  ...
  createData("Costos directos", 237, 9.0, 37, 4.3),
  createData("Costos de obra", 262, 16.0, 24, 6.0),
  createData("Gastos", 262, 16.0, 24, 6.0),
  createData("Inversiones", 262, 16.0, 24, 6.0),
  createData("Total", 262, 16.0, 24, 6.0),
];

export const TablaEgresosActuales = () => {
  return (
    <TableContainer component={Paper} sx={{ maxWidth: "100%" }}>
      <Table aria-label="simple table" sx={{ width: "50vw" }}>
        <TableHead>
          <TableRow>
